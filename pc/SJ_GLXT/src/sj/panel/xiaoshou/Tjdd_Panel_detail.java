...
import sj.panel.xiaoshou.Ddck_Panel_detail.AddDetail;
import sj.util.Calculat;
import sj.util.Item;

import dao.DB_Opreat;

public class Tjdd_Panel_detail extends JPanel
{
	...
	public JScrollPane createDetailPane()
	{
		...
		String[] tableHeads = new String[]{ "商品名称" , "商品数量" , "单位" 
				, "商品单价"  , "备注信息", "总价/元" , "实付金额" , "欠付金额" , "安装工人" , "安装费用" };
	...
	private class DeleteListener implements ActionListener
	{
		...
		public void actionPerformed(ActionEvent e)
		{
			...
			if(id > -1)
			{
				...
				sum2 = sum-sum1;
				sum3 = sum3-Double.parseDouble(table.getValueAt(id, 9).toString());
				updateZJ();
				dftm.removeRow(id);				
			}
			else
